...
function Not() {
  ...
  useEffect(() => {
    ...
    function getEvents() {
      ...
      setEventsArr(JSON.parse(localStorage.getItem("events")));
    }
  ...
  return (
    ...
    <div style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 50px)', display: 'flex', justifyContent: 'initial' }}>
      <div>
        <HeaderTop />
        <div style={{ display: 'flex', justifyContent: '-moz-initial' }}>
          <Sidebar />
          <div style={{ flexGrow: 1, maxWidth: '1600px', padding: '55px' }}>
